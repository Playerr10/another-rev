<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/public/header.php'); ?>
<div id="Container">
<div id="Body">
				...
				<div class="Legend">
					<ul class="BadgesList">
						<li id="Administrator">
							...
							<div>This badge identifies an account as belonging to a Roblox
								administrator. Only official Roblox administrators will possess this 
								badge. If someone claims to be an admin, but does not have this badge, 
								they are potentially trying to mislead you. If this happens, please 
								report abuse and we will delete the imposter's account.</div>
						</li>
...
<li id="ImageModerator">
				...
				<div id="FeaturedBadge_Community">
					...
					<div class="FeaturedBadgeContent">
						<div class="FeaturedBadgeIcon"><img src="/images/BuildersClub-125x125.png" width="125" height="125" border="0"></div>
					...
					<ul class="BadgesList">
						<li id="Homestead">
							...
							<div>The homestead badge is earned by having your personal 
								...
								their ability to build cool things that other Robloxians were interested
						...
						<li id="Bricksmith">
							...
							<div>The Bricksmith badge is earned by having a popular 
								...
								receive this award. Robloxians with Bricksmith badges are accomplished 
					...
					<ul class="BadgesList">
						<li id="Friendship">
							...
							<div>This badge is given to players who have embraced the 
								Roblox community and have made at least 20 friends. People who have this
						...
						<li id="Inviter">
							<h4>Inviter Badge</h4>
							<div>Robloxia is a vast uncharted realm, as large as the 
								imagination. Individuals who invite others to join in the effort of 
								mapping this mysterious region are honored in Robloxian society. 
								Citizens who successfully recruit three or more fellow explorers via the
								Share Roblox with a Friend mechanism are awarded with this badge.
							</div>
						</li>
					</ul>
				</div>
			...
			<div id="CombatBadges">
				<div class="Legend">
					<ul class="BadgesList">
						...
						<li id="Warrior">
							<h4>Warrior Badge</h4>
							<div>This badge is given to the warriors of Robloxia, who have
						...
						<li id="Bloxxer">
							...
							<div>Anyone who has earned this badge is a very dangerous 
								player indeed. Those Robloxians who excel at combat can one day hope to 
